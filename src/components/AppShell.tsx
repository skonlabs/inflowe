...
import { Home, FileText, Users, CheckCircle, Bell, Settings, Menu, X } from 'lucide-react';
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  {item.path === '/approvals' && (
                    <span className="absolute -top-1 -right-1.5 w-3.5 h-3.5 rounded-full bg-destructive text-destructive-foreground text-[9px] font-bold flex items-center justify-center">3</span>
                  )}
                </div>
